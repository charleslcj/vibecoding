...
export async function analyzeBuyerProfile(
  ...
  if (!apiKey) {
    console.warn("Gemini API Key missing, using deterministic fallback.");
  ...
  const response = await ai.models.generateContent({
    ...
    config: {
      ...
      responseSchema: {
        type: Type.OBJECT,
        properties: {
          archetype: { type: Type.STRING, description: "One of: The Systems Builder, The Driver, The Guardian, The Guide" },
          ...
          stats: {
            ...
            properties: {
              ...
              passionAlignment: { type: Type.NUMBER },
